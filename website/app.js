import {renderHomeCollections} from './home-collections.js?v=165';
import {spotlightRecord} from './collections-engine.js?v=165';
import { createCatalog } from "./catalog.js?v=165";
import { FEATURES } from "./features.js?v=165";
const DATA_URL = new URL("../site_export/data/catalog.json?v=165", import.meta.url);
...
async function init() {
  try {
    const [response, aliasesResponse, standaloneResponse, curationResponse] = await Promise.all([
      ...
      fetch(new URL('./collection-curation.json?v=165', import.meta.url)),
    ]);
