...
export const FIELDS = ['q','type','collection','group','sort','from','to','publication','subject','form','company','city','venue','person','role','completeness','entityType','entity','indexScope','text','origin','shown'];
